...
function SF_scripts(){
	...
	$("#flicker1").delay(600).queue(function(){
		$(this).addClass("flicker1").dequeue();
	});
	$("#flicker2").delay(900).queue(function(){
		$(this).addClass("flicker2").dequeue();
	});
	$("#flicker3").delay(600).queue(function(){
		$(this).addClass("flicker2").dequeue();
	});
	$("#flicker4").delay(900).queue(function(){
		$(this).addClass("flicker1").dequeue();
	});
	$("#flicker5").delay(600).queue(function(){
		$(this).addClass("flicker2").dequeue();
	});
	$("#flicker6").delay(900).queue(function(){
		$(this).addClass("flicker1").dequeue();
	});
	...
	if(typeof(AOS) !== 'undefined' && $("body").hasClass("SFG_body")===false){
		AOS.init({
			...
			//linear ease ease-in ease-out ease-in-out ease-in-back ease-out-back ease-in-out-back ease-in-sine ease-out-sine ease-in-out-sine ease-in-quad ease-out-quad ease-in-out-quad
